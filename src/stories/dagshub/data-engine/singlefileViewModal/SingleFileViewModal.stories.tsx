...
const itemDataMockList: itemData[] = [
  ...
  },
  {
    ...
    fileName: 'abc.wav',
    metadataList: [{ key: 'size', value: '234567', valueType: 'INTEGER', isAutoGenerated: true }],
    hasPrevious: true,
    hasNext: true
  },
  {
    ...
    metadataList: [
      ...
      { key: 'key', value: '345678', valueType: 'INTEGER' },
      { key: 'tal', value: '345678', valueType: 'INTEGER' },
      { key: 'itay', value: '345678', valueType: 'INTEGER' },
      { key: 'shahar', value: '345678', valueType: 'INTEGER' },
      { key: 'ron', value: '345678', valueType: 'INTEGER' },
      { key: 'bla', value: '345678', valueType: 'INTEGER' }
    ],
    hasPrevious: true,
    hasNext: true
  },
  {
    ...
    itemType: 'na',
    repoFilePath:
      'https://dagshub.com/DAGsHub-Official/annotations-showcase/src/main/data/text/brown-dog.txt',
    galleryFilePath:
      'https://dagshub.com/DAGsHub-Official/annotations-showcase/raw/main/data/text/brown-dog.txt',
    fileName: 'brown-dog.txt',
    metadataList: [{ key: 'size', value: '456789', valueType: 'INTEGER', isAutoGenerated: true }],
    hasPrevious: true,
    hasNext: false
  }
];
