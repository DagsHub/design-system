...
const itemDataMockList: ItemData[] = [
  ...
  },
  {
    ...
    itemIndex: 5,
    itemType: 'pdf',
    repoFilePath: '/assets/TextGeneratedByChatGpt.pdf',
    galleryFilePath: '/assets/TextGeneratedByChatGpt.pdf',
    fileName: 'TextGeneratedByChatGpt.pdf',
    metadataList: [{ key: 'size', value: '34567890', valueType: 'INTEGER', isAutoGenerated: true }],
    hasPrevious: true,
    hasNext: true
  },
  {
    itemIndex: 6, // expect to get n error fallback
    itemType: 'image',
    repoFilePath:
  ...
  },
  {
    ...
    itemType: 'na',
    repoFilePath:
      'https://dagshub.com/DAGsHub-Official/dagshub-docs/src/main/create_single_doc.py',
    galleryFilePath:
