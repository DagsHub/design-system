...
import MiniRepoCardsModal, {MiniRepoCardsModalProps} from '../../../components/dagshub/organization/mini-repo-cards-modal';

const meta: Meta<typeof MiniRepoCardsModal> = {
    title: 'DagsHub/Org/MiniRepoCardsModal',
