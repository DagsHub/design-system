...
export interface MetadataKeyValueListProps {
    ...
    onChangeHandler: (metadataList:{ key?: string; value?: string; valueType?: string; multiple: boolean; isAutoGenerated?: boolean; }[]) => void;
}
...
export function MetadataKeyValueList({
    ...
    return (
        <Box>
            ...
            {isEditable &&
                <StyledTextField
                    style={{borderBottom: "1px solid #E2E8F0", borderRadius:0, height:"100%", pointerEvents: 'none'}}
                    changeColorOnHover
                    InputProps={{
                        readOnly: true,
                        endAdornment:
