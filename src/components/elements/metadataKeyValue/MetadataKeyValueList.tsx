...
export function MetadataKeyValueList({
  ...
  const isDeletionEnabled=(metadataField:    {
    key?: string;
    value?: string;
    valueType?: string;
    multiple: boolean;
    ...
    if(isEditable && metadataField.isNewlyCreated){ //it should always be possible to delete newly created fields
      return true;
    }
    if (isEditable && deletionEnabled && !!onDeleteHandler){//logic for pre-existing fields
      return true;
    }
    return false;
  }
      ...
      >
        {temporaryMetadataList.map((metadataField, index) => (
          <MetadataKeyValuePair
            ...
            deletionEnabled={isDeletionEnabled(metadataField)}
