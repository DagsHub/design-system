        ...
        <div className="organization-plan-setting-tab">
            <div className="organization-plan-setting-tab__settings">
                ...
                <div className="setting-section">
                    ...
                    <div className="seats-in-use">{props.seatsInUse} /
                        <span className="seats-in-use__seats-in-plan">{props.seatsInPlan}
            ...
            <div className="tab-texts">
                <p className="current-plan-subscription">
                    You are currently subscribed to the {props.organizationPlan} plan, scheduled to renew on {props.renewDateString}.
