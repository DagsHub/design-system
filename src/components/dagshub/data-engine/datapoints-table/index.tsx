...
const header: Row = {
  columns: [
    ...
    <div className="people-table__header rest">Date created</div>,
    <div className="people-table__header rest">Size in bytes</div>,
    <div className="people-table__header rest">Dimensions</div>,
    <div className="people-table__header rest">Annotations</div>
  ]
};
    ...
    },
    {
      columns: [
        ...
        <div className="row two">
          {'Chronic Sinusitis.txt\n' +
            '\n' +
            'Description Patient having severe sinusitis about two to three months ago with facial discomfort, nasal congestion, eye pain, and postnasal drip symptoms.(Medical Transcription Sample Report)'}
        </div>,
        <div className="row rest">22-Jan-2023 04:58:14.00 (GMT+2)</div>,
        <div className="row rest">657.8 kB</div>,
        <div className="row rest">720x720</div>,
