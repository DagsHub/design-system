...
const SimpleCondition = ({
    ...
    const selectedOperator = operatorsList.find(operator => operator.id === condition.filter?.comparator);
            ...
            <Box
                ...
                {!isSimple && condition.not &&
                    <Box style={{
                        ...
                        <Typography variant={"medium"} style={{color: "rgba(84, 103, 222, 1)"}}>NOT</Typography>
                        <span style={{display: "flex", cursor: "pointer"}}><Icon
                            onClick={() => onChange({...condition, not: !condition.not})} icon={"solid-x-circle"}
                            width={16} height={16} fill={"rgba(148, 163, 184, 1)"}/></span>
                    </Box>
                }
                {condition.not &&
                    <Box style={{
                ...
                <ConditionDropdown
                    ...
                    initialChecked={selectedMetadataKey
                ...
                <ConditionDropdown
                    ...
                    initialChecked={selectedOperator
                ...
                <Button
                    ...
                    onClick={onRemove}
                    iconRight={<Icon icon={"solid-trash"} width={14} height={16} fill={"rgba(100, 116, 139, 1)"}/>}
                />
                <Button
