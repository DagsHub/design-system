...
import {MetadataKeyValuePair, MetadataKeyValuePairProps} from './MetadataKeyValuePair';
...
export function MetadataKeyValueList({
  ...
  useEffect(() => {
    console.log('temporaryMetadataList', temporaryMetadataList);
  ...
  const checkIfPairIsRemovable=(metadataField:    {
    ...
    if(editingEnabled && metadataField.isNewlyCreated){ //it should always be possible to delete newly created fields
      return true;
    }
    if (editingEnabled && deletionEnabled && !!onDeleteHandler && !metadataField.isAutoGenerated){//logic for pre-existing fields
      return true;
    }
    return false;
  }
      ...
      >
        {temporaryMetadataList.map((metadataField, index) => (
          <MetadataKeyValuePair
            ...
            deleteFieldPermanently={metadataField.isNewlyCreated?locallyRemoveMetadataFieldByIndex:permanentlyDeleteMetadataFieldByIndex}
          />
        ))}
      </Box>
      {editingEnabled && (
